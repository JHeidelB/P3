...
namespace P5
{
    public partial class FormMain : Form
    {
        ...
        {
            IssueDashboard form = new IssueDashboard(_CurrentAppUser);
            form.ShowDialog();
            form.Dispose();
        }
        ...
        {
            Modify form = new Modify(_CurrentAppUser);
            form.ShowDialog();
            form.Dispose();
        }
        ...
        {
            Modify form = new Modify(_CurrentAppUser, true);
            form.ShowDialog();
            form.Dispose();
        }
        ...
        {
            Create_Feature form = new Create_Feature(_CurrentAppUser);
            form.ShowDialog();
            form.Dispose();
        }

        private void toolStripMenuItemModify_Click(object sender, System.EventArgs e)
        {
            Modify_Feature form = new Modify_Feature(_CurrentAppUser);
            form.ShowDialog();
            form.Dispose();
        }
        ...
        {
            Select_Requirement form = new Select_Requirement(_CurrentAppUser);
            form.ShowDialog();
            form.Dispose();
        }
    }
